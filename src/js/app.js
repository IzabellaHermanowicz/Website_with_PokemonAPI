// build your app here
export const app = () =>document.getElementById("btn").addEventListener("click", refreshPage);function refreshPage(){
    window.location.reload();
}getPokemon(Math.floor(Math.random() * 808)); async function getPokemon(num) {
  ...
  for (let k=0; k<len; k++){
    ...
    <h5 class="card-title">
      <img src="https://img.icons8.com/color/48/000000/pokeball--v2.png">${data.name}
    </h5>
